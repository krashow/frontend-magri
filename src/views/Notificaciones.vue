<template>
  <div class="dashboard">
    ...
    <main class="main-content">
      ...
      <div
        v-if="currentRoute === '/notificaciones'"
        class="incidencias-asignadas-page"
      >
        ...
        <p
          v-else-if="
            !isLoading && incidencias.length === 0 && responsableId > 0
          "
          class="info-message"
        >
          No se encontraron incidencias asignadas para el ID
          {{ responsableId }}.
        </p>
              ...
              <tr v-for="incidencia in incidencias" :key="incidencia.id">
                ...
                <td>
                  <span
                    :class="[
                      'estado-badge',
                      getEstadoClass(incidencia.estado?.nombre),
                    ]"
                  >
                ...
                <td>
                  <button
                    class="action-btn"
                    @click="openDetalleModal(incidencia)"
                  >
