        ...
        <form @submit.prevent="$emit('save')">
          <div class="form-group">
            ...
            <textarea
              id="seguimiento"
              rows="4"
              v-model="gestionData.seguimiento"
              required
              placeholder="Describe las acciones tomadas o el progreso."
            ></textarea>
          </div>
          ...
          <div
            class="form-group"
            v-if="
              gestionData.nuevoEstado === 'Cerrado' ||
              gestionData.nuevoEstado === 'Resuelto'
            "
          >
